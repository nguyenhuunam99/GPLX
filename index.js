...
// import Routes from './components/banggiaxemay/Routes';
...
function Tabbienbao({ navigation }) {
  return (
    ...
    >
      ...
      <Tab.Screen name={All.BienBaoHieuLenhScreen} component={Bienbaohieulenh} />
      <Tab.Screen name={All.BienBaoNguyHiemScreen} component={Bienbaonguyhiem} />
      ...
      <Tab.Screen name={All.TuyenDuongDoiNgoaiScreen} component={Tuyenduongdoingoai} />
...
function HomeScreenStack({ navigation }) {
  return (
    <Stack.Navigator screenOptions={{
      ...
      <Stack.Screen name={All.MainScreen} component={Home} options={{
        headerLeft: () => (
          <TouchableOpacity onPress={() => { navigation.openDrawer() }} style={{ width: 40 }}>
      ...
      <Stack.Screen name={All.TraCuuLuatScreen} component={Tabtracuuluat} />
      ...
      <Stack.Screen name={All.KhaiNiemVaQuyTacScreen} component={Khainiemvaquytac} />
      <Stack.Screen name={All.HeThongBienBaoDuongBoScreen} component={Hethongbienbaoduongbo} />
      <Stack.Screen name={All.SaHinhScreen} component={Sahinh} />
      <Stack.Screen name={All.VanHoaVaDaoDucLaiXeScreen} component={Vanhoavadaoduclaixe} />
